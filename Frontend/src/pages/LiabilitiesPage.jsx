...
export default function LiabilitiesPage() {
  ...
  // simple local list (later replace with backend fetch)
  const [liabilities, setLiabilities] = useState([]);

  // modal
  const [isOpen, setIsOpen] = useState(false);

  // simple fields (same pattern as your friend)
        ...
        <main className="flex-1 min-w-0 bg-white overflow-auto">
          <div className="max-w-[1600px] mx-auto px-6 py-6 space-y-6">
            ...
            <div className="flex items-start sm:items-center justify-between gap-3 flex-col sm:flex-row">
              <div>
                <h1 className="text-3xl font-bold text-[#040303]">Liabilities</h1>
            ...
            <div className="bg-white border border-[#BFC0C0] rounded-lg p-6">
              <h3 className="font-semibold text-[#040303]">Total Liabilities</h3>
              ...
              <div className="mt-5">
                {liabilities.length === 0 ? (
                  <div className="h-24 rounded-md bg-white border border-dashed border-[#BFC0C0] flex flex-col items-center justify-center text-sm text-[#BFC0C0]">
                    ...
                    <p className="text-xs">Click “Add Liability” to get started.</p>
                  </div>
                ) : (
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {liabilities.map((l) => (
                          ...
                          >
                            <td className="py-3 font-medium text-[#040303]">{l.name}</td>
