...
export default function DashboardHighlightSection() {
  ...
  return (
    <section className="px-4 sm:px-6 pb-10 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
      <div
        className="relative overflow-hidden rounded-3xl border border-white/10 shadow-sm
                   min-h-[520px] sm:min-h-[620px] md:min-h-[520px]"
        style={{
      ...
      >
        ...
        <div className="relative p-5 sm:p-8 md:p-12">
          ...
          <h2 className="mt-3 text-2xl sm:text-3xl md:text-5xl font-extrabold text-white leading-tight text-center break-words">
            Premium AI Powered Wealth Management
            <br className="hidden md:block" />
            You Can Trust
          </h2>
            ...
            {items.map((it) => {
              ...
              return (
                <div
                  key={it.title}
                  className="rounded-2xl border border-white/15 bg-white/10 backdrop-blur-md p-4 sm:p-5
                             hover:bg-white/15 transition min-w-0"
                >
                  ...
                  <p className="mt-3 text-xs sm:text-sm text-white/70 leading-relaxed break-words">
                    {it.desc}
                  </p>
                </div>
              );
